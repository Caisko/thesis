...
for path, subdirnames, filenames in os.walk("gibson"):
    ...
    for filename in filenames:
      ...
      new_path="resizedTrainingImages"+"/"+ "gibson"#str(id)
      if not os.path.exists("C:/Users/Asus/Downloads/school/Image recognition project/resizedTrainingImages/gibson"):
            os.makedirs("C:/Users/Asus/Downloads/school/Image recognition project/resizedTrainingImages/gibson")
