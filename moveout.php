...
$sql = "SELECT * FROM gatepass where gatepass_status = 'transaction 5'  and `transaction` = 'approved' AND `in/out`='in'  and not gate_cat_2 = 'IN/OUT'  ";
...
if ($result->num_rows > 0) {
  ...
  <tr >
      ...
      <td ><a href="out.php? id=<?php echo $row["id"];?>" style="margin:5px;" class="btn btn-warning">Move Out</a></td>
...
$conn->close();
  ...
  $sql = "SELECT * FROM gatepass where gatepass_status = 'transaction 1'  and `transaction` = 'pending' and `in/out` = 'out' and not gate_cat_2 = 'IN/OUT'   ";
$result = $conn->query($sql);
...
if ($result->num_rows > 0) {
  ...
  <tbody>
    ...
    <tr data-href="view.php">
      ...
      <th scope="row"><a href="viewout.php?id=<?php echo $row["id"]; ?>" style="color:black;"><?php echo $row["gatepass_id"]; ?></a></th>
      <td><a href="#"><img src = "<?php echo $row["qr"];?>" style="width:50px;"></td>
      <td><?php echo $row["name"]; ?></td>
      <td><?php echo $row["date_register"]; ?></td>
      <td><?php echo $row["valid_until"]; ?></td>
      <td ><a href="out.php? id=<?php echo $row["id"];?>" style="margin:5px;" class="btn btn-warning">Approved</a></td>
...
$conn->close();
  ...
  $sql = "SELECT * FROM gatepass where gatepass_status = 'transaction 2'  and `transaction` = 'pending' and `in/out` = 'out' and not gate_cat_2 = 'IN/OUT'    ";
$result = $conn->query($sql);
...
$conn->close();
  ...
  $sql = "SELECT * FROM gatepass where gatepass_status = 'transaction 3'  and `transaction` = 'pending' and `in/out` = 'out' and not gate_cat_2 = 'IN/OUT'  ";
$result = $conn->query($sql);
...
$conn->close();
  ...
  $sql = "SELECT * FROM gatepass where gatepass_status = 'transaction 4'  and `transaction` = 'pending' and `in/out` = 'out' and not gate_cat_2 = 'IN/OUT'   ";
$result = $conn->query($sql);
...
$conn->close();
  ...
  $sql = "SELECT * FROM gatepass where gatepass_status = 'transaction 5'  and `transaction` = 'pending' and `in/out` = 'out' and not gate_cat_2 = 'IN/OUT' ";
$result = $conn->query($sql);
