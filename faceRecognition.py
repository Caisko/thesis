...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('flaskTesting/flask/Image recognition project/HaarCascade/haarcascade_frontalface_default.xml')#Load haar classifier
