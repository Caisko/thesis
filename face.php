  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Register Face</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<div class="card info-card customers-card">
  ...
  <div class="card-body">
   ...
   <form autocomplete="off" class="form-control" role="form" action="face_registration.php" method="post">

     

     <div class="row">
        
 <img src="face.png" style="border:solid 2px; height: 400px;width:800px;margin:auto;">
 
  </div><br>
   
      <div class="col-12">
        <button class="btn btn-primary w-100" type="submit" name="submit">Capture</button>
      </div>
