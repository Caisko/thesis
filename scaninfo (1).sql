...
CREATE TABLE `gatepass` (
  ...
  `qr` varchar(250) NOT NULL,
  `technical_name` text DEFAULT NULL,
  `gatepass_status` varchar(100) NOT NULL,
...
INSERT INTO `gatepass` (`id`, `gatepass_id`, `gatepass_cat`, `gate_cat_2`, `id_number`, `name`, `name_store`, `course`, `yr`, `section`, `address`, `date_register`, `valid_until`, `phone_number`, `description`, `qr`, `technical_name`, `gatepass_status`, `transaction`, `in/out`, `comment`, `fk_admins`) VALUES
(84, 'CVSUQRa7fe7f3', 'Student', 'VALID UNTIL', '2019230190', 'KHEN FELICES', NULL, 'bscs', '1', 'A', 'imus', '2023-01-02', '2023-12-31', '09203901', '123 laptop\r\n', 'temp/Qr9920b20baac7e25e3eedd23f4a856810.png', 'khen felices', 'transaction 5', 'approved', 'out', '0', 1),
(85, 'CVSUQRb47c512', 'Student', 'VALID UNTIL', '20930107070', 'austin', NULL, 'bscs', '1', 'A', 'qweewqewqeq', '2023-01-02', '2023-12-31', '02930290', 'imus', 'temp/Qrfe72b4450c5d2721abbad91bca2e559b.png', '', 'request', 'declined', NULL, '0', 1),
(86, 'CVSUQR971eebc', 'Student', 'VALID UNTIL', '20320390270', 'khen felices', NULL, 'bscs', '1', 'A', 'imus', '2023-01-03', '2023-01-18', '0902930190', 'walis', 'temp/Qr676bbbe14eb32771b17b5d57ced2fe9f.png', '', 'request', 'pending', NULL, '', 1),
(87, 'CVSUQRff8847d', 'Student', 'VALID UNTIL', '20920381808', 'JAZZ GIBSON GONZALES', NULL, 'BSCS', '1', 'A', 'IMUS', '2023-01-03', '2023-12-31', 'O93218318', 'SPEAKER', 'temp/Qr947760c20befa71e6c35559ea21fa786.png', '', 'transaction 5', 'approved', 'in', '0', 1),
(88, 'CVSUQR15318eb', 'Teacher', 'VALID UNTIL', '20188121', 'KHEN FELICES', NULL, NULL, NULL, NULL, 'Carsadang bago 1', '2023-01-08', '2023-01-10', '0955 555 5522', 'DA12742 SPEAKER RED', 'temp/Qr37021cde58d889dedef4072955945dfa.png', '', 'transaction 5', 'approved', 'in', '0', 1),
(89, 'CVSUQRa698b1e', 'Teacher', 'VALID UNTIL', '1230900', 'CRISOSTOMO IBARRA', NULL, NULL, NULL, NULL, 'BLK31 LOT 11 GREEN ESTATE PHASE1 MALAGASANG 1G IMUS CITY,CAVITE', '2023-01-09', '2023-01-19', '0955 555 5522', '12312 SPEAKER RED', 'temp/Qr388eb20e545c4825091aa1ac719bd344.png', '', 'request', 'pending', NULL, '', 1);
...
INSERT INTO `unit_number` (`id`, `unit_num_serial`, `user_id`) VALUES
(41, '123', 84),
(42, 'BBB233021380', 87);
