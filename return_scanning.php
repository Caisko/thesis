...
<div class="card info-card customers-card">
  ...
  <div class="card-body">
    <h5 class="card-title">Scan Face Here</h5>
    <form method="post" action="return_validate.php">
    <div class="row">
        <div class="col-sm-5 col-md-6">
        <div class="input-group mb-3">
        <input type="text" class="form-control" id="searchInput" placeholder="Search ID Number" style="height: 40px;">
 ...
 <br>
 <button type="button" class="btn btn-primary form-control">Capture</button>
        </div>
        <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0" style="margin-top:100px;">
            <p>Status: Returning</p>
            <p>Name: Jazz Gibson Gonzales</p>
            <p>ID Number: 201810049</p>
            <p>Course: BSCS 4C</p>
            <button type="submit" class="btn btn-primary " style="margin-top: 220px;width:200px;float:right;">Proceed</button>
         </div>
  </div>
