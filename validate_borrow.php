...
<div class="card info-card customers-card">
  ...
  <div class="card-body">
   ...
   <form autocomplete="off" class="form-control" role="form"  method="post">
     ...
     <div class="row">
   <div class="col-sm">
       <label for="yourName" class="form-label">Responsible Person:</label>
  
       <input type="text" class="form-control" id="yourName" name="fname" required>
     ...
     <div class="row">
     <div class="col-sm">
       <label for="yourName" class="form-label">For What Department: </label>
       <input type="text" class="form-control" id="yourName" name="fname" required>
     </div>
     
   <div class="col-sm">
       <label for="yourName" class="form-label">Number of Days to Use:</label>
  ...
  <br><!--End of row-->
      ...
      <div class="col-12">
        <button class="btn btn-primary w-100" type="submit" name="submit">Generate QR </button>
      </div><br>
