...
<li class="nav-item">
 ...
 <!--  <li class="nav-item">
  ...
  <!-- Recent Sales -->
   ...
   <select name="gender" class="form-select" id="yourName" style="width:150px;">
     <option default hidden> Filter </option>
     <option value="month"> Month </option>
     <option value="month"> In Used </option>
     <option value="month"> Return </option>
     <option value="month"> Unreturned </option>
</select>
 </div>
...
<table class="table">
  <thead>
    <tr>
      ...
      <th scope="col">Crs/YR and Section</th>
      <th scope="col">Equip. Borrowed</th>
  ...
  <tbody>
    <tr>
      <td >Ramil Huelle</td>
      <td>DCS</td>
      <td>Jazz Gibson Gonzales</td>
      <td>BSCS 4 C</td>
      <td>Printer</td>
      <td>Canon PIXMA TR8620a</td>
      <td>1</td>
      <td>01-02-22</td>
      <td></td>
      <td style="color:gold">IN USE</td>
    </tr>
    <tr>
      <td >John Michael Malabad</td>
      <td>P.E</td>
      <td>John Michael Malabad</td>
     
      <td>Staff</td>
      <td>Projector</td>
      <td>DHN DM460UUST 3LCD</td>
      <td>1</td>
      <td>01-01-22</td>
      <td></td>
      <td style="color:red">UNRETURNED</td>
    </tr>
    <tr>
      <td>James Reid</td>
      <td>MIS</td>
