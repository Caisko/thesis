  ...
  <div class="row align-items-start">
    ...
    <p class="form-control-plaintext">Transaction ID:  <strong> <?php echo $row["gatepass_id"];?></strong></p>
         ...
         <p class="text-justify form-control-plaintext">&nbsp;&nbsp;&nbsp;&nbsp;Please Allow Mr./Mrs to <u><?php echo $row["name"]; ?></u> Move Out personal Equipment/ Items from Cavite State University  
                ...
                <div class="row align-items-start">
                    <div class="col">
                    <p class="form-control-plaintext">SIGNATURE</p>
                    </div>
                    <div class="col">
                    <p class="form-control-plaintext">SIGNATURE:</p>
                    </div>
         ...
         <input  class="btn btn-primary w-100 hidden-print"  type="button" onclick="window.print()" value="Print Qr Code">
    </div>
  </div>
